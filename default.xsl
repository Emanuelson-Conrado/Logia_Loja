...
>
	...
	<a href="https://github.com/Emanuelson-Conrado/LogiaLoja.git"><span>Início</span></a>
	...
	<a href="https://github.com/Emanuelson-Conrado/LogiaLoja.git"><span>Início</span></a>
			...
			<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
					...
					<a href="https://github.com/Emanuelson-Conrado/LogiaLoja.git/sitemap.xml"><span>Índice do sitemap</span></a>
						<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
	...
	<div id="content-head">
		...
		<p>Gerado por <a href="https://aioseo.com/?utm_source=WordPress&#038;utm_campaign=liteplugin&#038;utm_medium=xml-sitemap" target="_blank">All in One SEO</a>, este é um sitemap em XML, destinado a ser consumido por mecanismos de pesquisa como Google ou Bing.</p>
		<p>
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				e foi gerado em 5 de junho de 2023 às 14:33			</p>
		</xsl:if>
	</div>
</xsl:template>
	...
	<a href="https://github.com/Emanuelson-Conrado/LogiaLoja.git"><span>Início</span></a>
		...
		<div class="empty-sitemap__buttons">
			<a href="https://github.com/Emanuelson-Conrado/LogiaLoja.git" class="button">Voltar à página inicial</a>
					</div>
